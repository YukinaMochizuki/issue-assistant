package tw.yukina.sitcon.issue.assistant.views.playground.cardlist;
...
public class CardListView extends Div implements AfterNavigationObserver {
    ...
    private HorizontalLayout createCard(tw.yukina.sitcon.issue.assistant.views.playground.cardlist.Person person) {
...
//        actions.add(likeIcon, likes, commentIcon, comments, shareIcon, shares);
    ...
    public void afterNavigation(AfterNavigationEvent event) {
        ...
        List<tw.yukina.sitcon.issue.assistant.views.playground.cardlist.Person> persons = Arrays.asList( //
    ...
    private static tw.yukina.sitcon.issue.assistant.views.playground.cardlist.Person createPerson(String image, String name, String date, String post, String likes,
                                                                                                  String comments, String shares) {
        tw.yukina.sitcon.issue.assistant.views.playground.cardlist.Person p = new tw.yukina.sitcon.issue.assistant.views.playground.cardlist.Person();
        p.setImage(image);
        p.setName(name);
        p.setDate(date);
        p.setPost(post);
