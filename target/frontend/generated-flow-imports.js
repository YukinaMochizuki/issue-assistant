...
import $css_0 from 'Frontend/styles/views/cardlist/card-list-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_0}</style></custom-style>`);
import $css_1 from 'Frontend/styles/views/newitem/new-item-view.css';
addCssBlock(`<custom-style><style>${$css_1}</style></custom-style>`);
import $css_2 from 'Frontend/styles/views/dialog/abstract-dialog.css';
...
import $css_5 from 'Frontend/styles/views/dialog/dialog-overlay.css';
addCssBlock(`<dom-module id="flow_css_mod_5" theme-for="vaadin-dialog-overlay"><template><style>${$css_5}</style></template></dom-module>`);
